...
class ResultsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create result" do
    assert_difference('Result.count') do
      post results_url, params: { result: { score: @result.score, win_loose_tie: @result.win_loose_tie } }
    end
  ...
  test "should update result" do
    patch result_url(@result), params: { result: { score: @result.score, win_loose_tie: @result.win_loose_tie } }
